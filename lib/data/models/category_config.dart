...
class CategoryConfig extends Equatable {
  ...
  static List<CategoryConfig> get defaults => [
    CategoryConfig(
      ...
      colorValue: AppColors.positive.toARGB32(),
      order: 0,
      isDefault: true,
    ),
    CategoryConfig(
      ...
      colorValue: AppColors.negative.toARGB32(),
      order: 1,
      isDefault: true,
    ),
    CategoryConfig(
      ...
      colorValue: AppColors.gratitude.toARGB32(),
      order: 2,
      isDefault: true,
    ),
    CategoryConfig(
      ...
      colorValue: AppColors.beauty.toARGB32(),
      order: 3,
      isDefault: true,
    ),
    CategoryConfig(
      ...
      colorValue: AppColors.identity.toARGB32(),
      order: 4,
      isDefault: true,
    ),
  ];
