...
/// Original short system prompt (pre-#122).
///
/// Used as a diagnostic toggle via Developer settings to test whether the
/// detailed prompt causes Gemini Live native-audio to not respond (#157).
const dailyCallMinimalPrompt = '''
